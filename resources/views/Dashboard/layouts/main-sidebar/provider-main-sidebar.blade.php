            ...
            <div class="dropdown user-pro-body">
                ...
                <div class="user-info">
                    <h4 class="font-weight-semibold mt-3 mb-0">
                        ...
                        @if($user = Auth::guard('provider')->user())
                            {{ $user->name }}
                        @endif
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                @if(Auth::guard('provider')->user())
                    <a class="side-menu__item" href="{{  route('provider.dashboard') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3"/><path d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z"/></svg><span class="side-menu__label">{{trans('dashboard/main_trans.dashboard')}}</span><span class="badge badge-success side-badge">1</span></a>
                @endif
                @if(Auth::guard('agent')->user())
                    <a class="side-menu__item" href="{{ route('agent.dashboard') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3"/><path d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z"/></svg><span class="side-menu__label">{{trans('dashboard/main_trans.dashboard')}}</span><span class="badge badge-success side-badge">1</span></a>
                @endif
            </li>

            <li class="slide">
                <a class="side-menu__item"  data-toggle="slide"   href="{{ url('/') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">الرحلات</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/trips' )  }}"> اضافة رحلة</a></li>
                    <li><a class="slide-item" href="{{ route('provider.requests') }}"> الرحلات المطلوبة</a></li>
                    <li><a class="slide-item" href="{{ route('provider.confirmedTrips') }}"> الرحلات المؤكدة</a></li>
                    <li><a class="slide-item" href="{{ route('provider.rejectedTrips') }}"> الرحلات الملغاة</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M4 12c0 4.08 3.06 7.44 7 7.93V4.07C7.05 4.56 4 7.92 4 12z" opacity=".3"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.94-.49-7-3.85-7-7.93s3.05-7.44 7-7.93v15.86zm2-15.86c1.03.13 2 .45 2.87.93H13v-.93zM13 7h5.24c.25.31.48.65.68 1H13V7zm0 3h6.74c.08.33.15.66.19 1H13v-1zm0 9.93V19h2.87c-.87.48-1.84.8-2.87.93zM18.24 17H13v-1h5.92c-.2.35-.43.69-.68 1zm1.5-3H13v-1h6.93c-.04.34-.11.67-.19 1z"/></svg><span class="side-menu__label">الجوزات</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('WatingConfirm.requests') }}"> قائمة الحجوزات المدفوعة ف انتظار التاكيد</a></li>
                    <li><a class="slide-item" href="{{ route('provider.confirmedTrips') }}"> قائمة الحجوزات الموكدة</a></li>
                    <li><a class="slide-item" href="{{ route('provider.rejectedTrips') }}">  قائمة الحجوزات الملغية</a></li>
