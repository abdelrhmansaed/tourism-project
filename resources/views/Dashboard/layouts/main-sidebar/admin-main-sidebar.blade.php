    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('agent.bookings' ) }}">قائمة الحجوزات</a></li>
                    <li><a class="slide-item" href="{{ route('trips.providerApproved') }}"> قائمة الحجوزات ف انتظار الدفع</a></li>
