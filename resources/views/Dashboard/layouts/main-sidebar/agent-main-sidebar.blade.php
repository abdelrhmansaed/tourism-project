...
{{--                        @endphp--}}
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/trips' )  }}">قائمة الرحلات المتوفرة </a></li>
                    <li><a class="slide-item" href="{{ route('agent.requests') }}">رحلاتي المطلوبة</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ route('agent.confirmedTrips') }}"> قائمة الحجوزات الموكدة</a></li>
                    <li><a class="slide-item" href="{{ route('agent.rejectedTrips') }}">  قائمة الحجوزات الملغية</a></li>
